...
| 22 | **Tasa de ruido del hook, sin medir.** 6 disparos en las dos primeras sesiones (2026-08-31), **los 6 falsos positivos**, en sesiones que no escribieron una sola línea de SQL. ⛔ **No corregir todavía — primero medir**, separando las dos clases (abajo). ⛔ **El instrumento NO existe todavía y el conteo a mano no lo es:** en la sesión del inventario el hook disparó del orden de 20 veces y perdí la cuenta exacta a mitad de camino. Una tasa medida de memoria no sirve para decidir sobre el hook. **Pendiente: que el propio hook apendee cada disparo a un ledger local** (fecha, herramienta, qué regla matcheó). ⚠️ Antes de tocarlo — el hook es contrato en dos repos (R1 punto 9): o el cambio se aplica también en G-Vento, o la divergencia se anota como decisión tomada. **Decisión abierta, planteada al usuario el 2026-08-31.** | 🔴 **6 de 6 NO es una tasa.** El denominador es "sesiones que no escribieron SQL": ahí el 100% de falsos positivos es el resultado *esperado*, no una anomalía. La tasa real aparece cuando existan sesiones que **sí** escriban SQL, porque solo ahí hay verdaderos positivos posibles. Citar "6 de 6" como tasa de ruido sería el error de proxy de R4 sobre nuestra propia medición. |
